		...
		return { //this:ActionBasciFsm
				...
				state("s1") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t012",targetState="indoor",cond=whenReply("accept"))
					transition(edgeName="t013",targetState="riprova",cond=whenReply("reject"))
				}	 
				state("riprova") { //this:State
					...
					sysaction { //it:State
				 	 		stateTimer = TimerActor("timer_riprova", 
				 	 					  scope, context!!, "local_tout_"+name+"_riprova", 6000.toLong() )  //OCT2023
					}	 	 
					 transition(edgeName="wait14",targetState="s1",cond=whenTimeout("local_tout_"+name+"_riprova"))   
				}	 
				state("indoor") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t115",targetState="giveticket",cond=whenTimeout("local_tout_"+name+"_indoor"))   
				}	 
				state("giveticket") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t216",targetState="checkresponse",cond=whenReply("ticketcheck"))
				}	 
				...
				state("unloading") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t317",targetState="truck",cond=whenDispatch("truckDriver"))
				}	 
				state("truck") { //this:State
					...
					sysaction { //it:State
				 	 		stateTimer = TimerActor("timer_truck", 
				 	 					  scope, context!!, "local_tout_"+name+"_truck", 200.toLong() )  //OCT2023
					}	 	 
					 transition(edgeName="t318",targetState="s1",cond=whenTimeout("local_tout_"+name+"_truck"))   
				}	 
			}
		}
} 
