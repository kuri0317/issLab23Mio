...
class Coldroom ( name: String, scope: CoroutineScope, isconfined: Boolean=false, isdynamic: Boolean=false ) : 
	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
						CommUtils.outcyan("COLDROOM:  attivo, peso attuale in frigo = $Peso")
				...
				state("s1") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t05",targetState="controllaPeso",cond=whenRequest("fwrequest"))
					transition(edgeName="t06",targetState="s2",cond=whenRequest("load_CR"))
					transition(edgeName="t07",targetState="delete_Reservation",cond=whenRequest("delete_Reservation"))
				}	 
